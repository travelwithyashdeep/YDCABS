      ...
      <div className="max-w-7xl mx-auto w-full relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        ...
        <div className="lg:col-span-7 flex flex-col items-start text-left space-y-4">
          ...
          <div className="flex items-center gap-3">
            <Link
              href={"tel:+919079395654"}
              className="bg-brand rounded-3xl hover:scale-110 transition duration-200 text-neutral-50 font-medium px-4 py-3 "
            >
              Book an Call
            </Link>{" "}
            <a
              ...
              className="bg-white px-4 py-3 flex items-center hover:scale-110 transition duration-200 gap-2 rounded-3xl font-medium text-green-500 cursor-pointer"
            >
              <svg
                width="19"
                height="19"
