  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <section className="py-2 bg-[#FAFAFA] border-t border-gray-250/20 -">
...
//             isLast ? "bg-neutral-200 border border-neutral-200" : "bg-blue-500"
//           }`}
//         >
//           <ul
...
//                 <div>
//                   <p className="text-xs text-gray-400">Min Round Trip</p>
//                   <p
...
//                 </div>
//                 <div>
//                   <p className="text-xs text-gray-400">Driver Allowance</p>
//                   <p
//                     className={`text-sm font-semibold ${
//                       isLast ? "text-neutral-300" : "text-gray-900"
//                     }`}
